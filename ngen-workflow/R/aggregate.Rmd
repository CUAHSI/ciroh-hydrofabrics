...
remotes::install_local("/Users/scootna/projects/ciroh-hydrofabrics/ngen-workflow/lynker-spatial/hfaggregate")
```
...
```{r}
hf_path <- "vpu_01_out/refactored_reference_hydrofabric.gpkg"
```
