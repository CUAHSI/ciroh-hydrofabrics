...
Packages were installed like this: - GDAL must be installed with Spatialite support. I did this on mac like this: - brew install gdal libspatialite sqlite - check that it's working as expected: gdalinfo --formats \| grep -i spatial - install.packages("sf", type = "source") \# make sure SF is install with spatialite support - remotes::install_github("[lynker-spatial/hfutils\@f74e9a41beaddf539c9420fc0f01ed1dc18820a2](mailto:lynker-spatial/hfutils@f74e9a41beaddf539c9420fc0f01ed1dc18820a2){.email}") \# HEAD was failing - remotes::install_github("lynker-spatial/hfrefactor") - whitebox::install_whitebox()
