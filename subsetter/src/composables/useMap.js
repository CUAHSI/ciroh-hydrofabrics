    ...
    function initMap() {
      ...
      state.map.on("styledata", () => {
        ...
        state.map.addSource("oconus_ref_flowpaths", {
          type: "vector",
          url: "pmtiles://https://s3.hydroshare.org/sblack/4219997533bf46a1893e9ba0232403eb/data/contents/map/only_geometry/reference/flowpaths.pmtiles",
        });
        state.map.addLayer(
          {
            id: "ref_flowpaths",
        ...
        state.map.addSource("oconus_ref_divides", {
          type: "vector",
          url: "pmtiles://https://s3.hydroshare.org/sblack/4219997533bf46a1893e9ba0232403eb/data/contents/map/only_geometry/reference/divides.pmtiles",
        });
        state.map.addLayer(
          {
            id: "ref_divides",
